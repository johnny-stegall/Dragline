...
;(function(window, document, undefined)
{
    ...
    ****************************************************************************/
    init: function(element, valueAccessor, allBindingsAccessor, viewModel, bindingContext)
    {
      if (!window.jQuery)
        ...
        throw new Error("The jQuery UI Sortable component is required.");
      else if (!ko.mapping)
        throw new Error("The Knockout Mapping plugin is required.");
  ...
  **************************************************************************/
  function cacheLayout(metaform)
  {
    ...
    localStorage[STORAGE_PREFIX + document.location] = cachedData;
  }
  ...
  ****************************************************************************/
  function createFieldset(formElement, metaform)
  {
    if (!formElement)
      ...
      throw new Error("The title for the FIELDSET is required.");
