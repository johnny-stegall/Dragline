...
;(function($, window, document, undefined)
{
  ...
  **************************************************************************/
  function activateBookmark(targetElement, e)
  {
    if (e)
    {
      this.ActiveHeading = $.grep(this.Headings, function(target)
      {
      ...
      this.ActiveHeading = targetElement;

    this.Element
      .find("li.Active")
      .removeClass("Active");

    this.Element.find("[href='#" + this.ActiveHeading.Heading.attr("id") + "']")
      .parents("li")
      .addClass("Active");
  }
  ...
  **************************************************************************/
  function trackBookmarks()
  {
    ...
    {
      activeHeader = this.Headings[this.Headings.length - 1];
      return this.ActiveHeading != activeHeader && activateBookmark.call(this, activeHeader);
    }

    if (this.ActiveHeading && scrollTop <= this.Headings[0].Offset)
    {
      activeHeader = this.Headings[0]
      return this.ActiveHeading != activeHeader && activateBookmark.call(this, activeHeader);
    }
    ...
    for (var headerIndex = this.Headings.length; headerIndex--;)
    {
      ...
      {
        activateBookmark.call(this, this.Headings[headerIndex]);
        break;
      }
    }
  }
