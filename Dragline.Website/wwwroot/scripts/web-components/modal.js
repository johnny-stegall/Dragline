...
;(function(window, document, undefined)
{
  ...
  ****************************************************************************/
  modalPrototype.attachedCallback = function()
  {
  ...
  ****************************************************************************/
  modalPrototype.hideDialog = function()
  {
  ...
  ****************************************************************************/
  modalPrototype.prompt = function(title, message, buttons)
  {
  ...
  * deletion.
  ****************************************************************************/
  modalPrototype.promptToDelete = function(message, deleteCallback)
  {
  ...
  * cancel the action.
  ****************************************************************************/
  modalPrototype.promptToSave = function(message, saveCallback, continueCallback, cancelCallback)
  {
    if (typeof (message) === "function")
    {
  ...
  **************************************************************************/
  modalPrototype.showDialog = function(element, title, options, callback, buttons)
  {
    if (!element)
  ...
  let Modal = document.registerElement("dragline-modal", { prototype: modalPrototype });
